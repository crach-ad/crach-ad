        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-start gap-4">
              ...
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">Collaborators & Partners</h1>
              <p className="max-w-[700px] text-muted-foreground md:text-xl/relaxed">
                Organizations and individuals I work with to advance STEM education.
              </p>
              <Separator className="my-4" />
            </div>
            <div className="flex items-center justify-center py-20">
              <div className="text-center space-y-4">
                <h2 className="text-2xl font-medium">Collaborator Information Coming Soon</h2>
                <p className="text-muted-foreground">
                  We're currently updating our collaborator and partner information. Check back soon!
                </p>
              </div>
            </div>
          </div>
